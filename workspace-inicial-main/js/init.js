...
const PRODUCT_INFO_URL = "http://localhost:3000/api/emercado-api/products/";
const PRODUCT_INFO_COMMENTS_URL = "http://localhost:3000/api/emercado-api/products_comments/";
const CART_INFO_URL = "http://localhost:3000/api/emercado-api/user_cart/";
const CART_BUY_URL = "http://localhost:3000/api/emercado-api/cart/buy.json";
const LOGIN_API = "";
const EXT_TYPE = ".json";
